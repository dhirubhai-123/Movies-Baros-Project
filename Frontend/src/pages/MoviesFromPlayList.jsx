...
const MoviesFromPlayList = () => {
    ...
    const { authUser, getContentFromPlayList, showsFromPlayList, moviesFromPlayList } = useAuthStore();
        ...
        <div className="min-h-screen bg-gradient-to-b from-base-200 to-base-100">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {/* {
                        showsFromPlayList && moviesFromPlayList ?
                            showsFromPlayList.length === 0 || moviesFromPlayList.length === 0 &&
                    ...
                    {
                        moviesFromPlayList && moviesFromPlayList.length > 0 &&
                        moviesFromPlayList.map((item, index) => {
                            ...
                            <div className="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div className="px-5 pb-5">
                                    <a href="#">
                                        <h3 className="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">Movie / Show Name</h3>
                                    </a>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <a href="#"
                                            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Remove</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    {
                        showsFromPlayList && showsFromPlayList.length > 0 &&
                        showsFromPlayList.map((item, index) => {
