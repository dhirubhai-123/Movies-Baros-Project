...
const ShowDetails = () => {
    ...
    const { detailsOfShow, getShowDetails, relatedYoutubeVideos } = useAuthStore();
        ...
        return <div className="w-screen h-screen flex justify-center items-center bg-gradient-to-r from-pink-200 via-pink-300 to-pink-500">
            <div className="text-center">
                ...
                <p className="text-xl text-gray-700 mb-4 max-w-sm mx-auto">
                    We're sorry, we couldn't find the show you're looking for.
                    Please check the show ID or try again later.
                </p>
        ...
        <div className="container mx-auto p-4 md:p-8 lg:max-w-7xl">
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl">
                ...
                <figure className="md:flex-1">
                    <img
                        src={detailsOfShow.showPoster}
                        alt={detailsOfShow.showName}
                ...
                <div className="card-body md:flex-1 p-4 md:p-8 space-y-6">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-3xl md:text-4xl font-bold text-primary">
                            {detailsOfShow.showName}
                        </h1>
                        <p className="text-gray-600 text-lg">
                            {detailsOfShow.showDescription}
                        </p>
                        <div className="flex flex-wrap gap-4 text-sm">
                            <div className="badge badge-accent badge-lg">
                                {new Date(detailsOfShow.showReleaseDate).toLocaleDateString()}
                            </div>
                            <div className="badge badge-secondary badge-lg">
                                {detailsOfShow.showVerdict}
                            </div>
                            <div className="badge badge-info badge-lg">
                                {detailsOfShow.showLanguage}
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="stats shadow">
                            <div className="stat">
                                ...
                                <div className="stat-value text-primary">
                                    {detailsOfShow.showMovieBarosRating}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="stats shadow">
                            <div className="stat">
                                ...
                                <div className="stat-value text-accent">
                                    {detailsOfShow.showRottenTomatoesRating}%
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {Object.values(detailsOfShow.showGenre).map((genre, index) => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="bg-base-200 p-4 rounded-lg">
                                ...
                                <p className='hover:text-blue-500'>
                                    <a href={`https://en.wikipedia.org/wiki/${detailsOfShow.showDirector}`}>{detailsOfShow.showDirector}</a>
                                </p>
                            </div>
                            <div className="bg-base-200 p-4 rounded-lg">
                                <h4 className="font-bold text-lg mb-2">Star Cast</h4>
                                <ul className="list-disc pl-4">
                                    {Object.values(detailsOfShow.showStarCast).map((member, index) => (
                            ...
                            <div className="bg-base-200 p-4 rounded-lg">
                                ...
                                <ul className="list-disc pl-4">
                                    {Object.values(detailsOfShow.showCrewCast).map((member, index) => (
                                        <a href={`https://en.wikipedia.org/wiki/${member}`}><li key={index} className="text-sm hover:text-blue-500">{member}</li></a>
                                    ))}
                                </ul>
                            </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        {Object.values(detailsOfShow.showWatchLinks).map((link, index) => (
                            link.trim() !== "NA" && (
                                <a
                                    key={index}
                                    href={link}
                    ...
                    <div className="mt-4">
                        <a
                            href={detailsOfShow.showTrailer}
                            target="_blank"
                            rel="noopener noreferrer"
